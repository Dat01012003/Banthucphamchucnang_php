...
$sql = "SELECT id, img,img1,img2, tenhang, tensanpham, gia FROM sanpham WHERE category = 'Mẹ & bé'";
...
<body>
                        ...
                        <div class="product-block col-lg-3 col-md-3 col-sm-4 col-6"
                            ...
                            <div style="border: 1px solid rgba(128, 128, 128, 0.1); padding-bottom: 15px;">
                                ...
                                <div class="product-buttons d-flex justify-content-between mt-3 px-2">
                                    ...
                                    <a href="../product editing/delete_sp_me&be.php?id=<?php echo $row['id']; ?>"
            ...
            <div class="modal-content">
                <form id="editForm" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Chỉnh sửa sản phẩm Mẹ $ Bé</h5>
    ...
    document.querySelectorAll('.edit-button').forEach(button => {
        button.addEventListener('click', function() {
            ...
            fetch('../product editing/edit_product_me&be.php', {
                    method: 'POST',
                    headers: {
    ...
    document.getElementById('saveChanges').addEventListener('click', function() {
        ...
        fetch('../product editing/update_product_me&be.php', {
                method: 'POST',
                body: formData
            })
