...
<head>
    ...
    <title>Bảo Vệ Gan Thận Phổi</title>
...
<body>
    <div id="main-body">
        <?php
            ...
            WHERE category = 'Chăm sóc sức khỏe' AND category_subtype = 'Bảo vệ-gan-thận-phổi'";
  $result = mysqli_query($conn, $query);
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div style="padding: 0 12px;">
                        <div class="bg-white">
                            <h2 style="font-size: 20px; margin: 0; padding: 10px;">Bảo Vệ Gan Thận Phổi</h2>
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterProducts() {
            ...
            xhr.open('POST', '../filter_products/filter_products_bcganthanphoi.php', true);
