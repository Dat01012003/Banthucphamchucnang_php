...
<head>
    ...
    <title>Bổ Sung Canxi - Khớp</title>
...
<body>
    <div id="main-body">
        <?php
            ...
            // Truy vấn dữ liệu từ bảng 'sanpham' với category là 'Bổ Sung Canxi - Khớp'
            $query = "SELECT id, img, tenhang, tensanpham, gia FROM sanpham 
            WHERE category = 'Chăm sóc sức khỏe' AND category_subtype = 'Bổ sung canxi,xương khớp'";
  $result = mysqli_query($conn, $query);
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div style="padding: 0 12px;">
                        <div class="bg-white">
                            <h2 style="font-size: 20px; margin: 0; padding: 10px;">Bổ Sung Canxi - Khớp</h2>
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterProducts() {
            ...
            xhr.open('POST', '../filter_products/filter_products_canxi.php', true);
