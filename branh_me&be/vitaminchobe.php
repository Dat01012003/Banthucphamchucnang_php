...
$query = "SELECT id, img, tenhang, tensanpham, gia FROM sanpham 
          WHERE category = 'Mẹ & bé' AND category_subtype = 'Vitamin dành cho bé'";
            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div style="padding: 0 12px;">
                        <div class="bg-white">
                            <h2 style="font-size: 20px; margin: 0; padding: 10px;">Đẹp Da Dài Tóc</h2>
                        </div>
                    </div>
                    <div class="container" style="background-color: #f5f5f5;">
                        <div class="row">
                            ...
                            <div class="product-block col-lg-3 col-md-3 col-sm-4 col-6"
                                ...
                                <div class="a" style="border: 1px solid rgba(128, 128, 128, 0.1);">
                                    <div class="product-img">
                                        <a href="../product details/super_sale.php?id=<?php echo $row['id']; ?>"
                            ...
                            if ($count === 0) {
                                echo "<p style='text-align: center; padding: 20px;'>Chưa có sản phẩm nào trong danh mục này</p>";
                            }
                            ?>
                        </div>
                    </div>
